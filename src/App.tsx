  ...
  return (
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/supratensiune" element={<Supratensiuni products={supratensiune}/>} />
        <Route path="/paratrasnet" element={<Paratrasnet products={paratrasnet}/>}/>
        <Route path={`/${data.impamantare}/:id`} element={<Products link={data.impamantare} products={impamantare.data} collection="IMPAMANTARE"/>}/>
        <Route path={`/${data.supratensiune}/:id`} element={<Products link={data.supratensiune} products={supratensiune.data} collection="SUPRATENSIUNI"/>}/>                 
        <Route path={`/${data.paratrasnet}/:id`} element={<Products link={data.paratrasnet} products={paratrasnet.data} collection="PARATRASNET"/>}/>                 
